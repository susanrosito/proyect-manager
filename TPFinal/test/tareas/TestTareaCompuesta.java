...
public class TestTareaCompuesta extends TestCase{
	...
	{	
		...
		/*A continuaci�n se setean todos las tareas simples que son todos mock objects capaces de
		 ...
		 * y s�lo la tarea simple que representa a la tarea cerrada espera el mensaje reAbrite(this.unMotivo)
	...
	public void testConstructor (){
		...
		assertSame("Confirma que la descripcci�n enviada por parametro se guardo correctamente " +
	...
	public void testAgregarTarea()
	{
		...
		assertTrue("Confirma que el tama�o de la lista de tareas aumento solo uno en cantidad.", 
