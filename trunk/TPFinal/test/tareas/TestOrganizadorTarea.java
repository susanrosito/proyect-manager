...
public class TestOrganizadorTarea extends TestCase{
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje cerrate() a la tareaSimple
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje cerrate() a la tareaCompuesta
	 * que contiene, cuando lo recibe.
	 */
   ...
   /**
	 * Este test comprueba que el organizador de tareas env�e el mensaje estaEnTiempo() a la tareaSimple
	 * que contiene y retorne lo que esta retornar�a,cuando lo recibe.
	 */
	public void testEstaEnTiempoTareaSimple() {
	 ...
	 /**
	 * Este test comprueba que el organizador de tareas env�e el mensaje estaEnTiempo() a la tareaCompuesta
	 * que contiene y retorne lo que esta retornar�a,cuando lo recibe.
	 */
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje estaProximaAVencer() a la tareaSimple
	 * que contiene y retorne lo que esta retornar�a,cuando lo recibe.
	 */
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje estaProximaAVencer() a la tareaCompuesta
	 * que contiene y retorne lo que esta retornar�a,cuando lo recibe.
	 */
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje reAbrite() a la tareaSimple
	 * que contiene.
	 */
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje reAbrite() a la tareaCompuesta
	 * que contiene.
	 */
   ...
   /**
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje verEstado() a la tareaSimple
	 * que contiene y retorne lo que esta retornar�a al enviarselo. 
	 */
	...
	/**
	 * Este test comprueba que el organizador de tareas env�e el mensaje verEstado() a la tareaCompuesta
	 * que contiene y retorne lo que esta retornar�a al enviarselo. 
	 */
